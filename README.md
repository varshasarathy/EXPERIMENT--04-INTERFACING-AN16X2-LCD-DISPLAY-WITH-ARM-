...
#include"lcd.h"
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
  	  ...
  	  Lcd_cursor(&lcd ,1,0);
  	  Lcd_string(&lcd, "REVATHI K");
```

## Output screen shots of proteus  :

 ![image](https://github.com/user-attachments/assets/9021f4ce-e89e-448c-9030-97ddaf44ee23)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 ![image](https://github.com/user-attachments/assets/4011d607-58ad-4a96-9806-5d8aa2193cab)
